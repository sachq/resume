...
\section{Technical Skills}
{
	...
	\begin{itemize}[topsep=0pt, partopsep=0pt, itemsep=0pt, parsep=0pt]
		...
		\item \textbf{Programming Languages \& Paradigms} - TypeScript/JavaScript, Python, Dart, Go (currently learning), Data Structures \& Algorithms, OOP, SOLID, Functional \& Modular Programming
